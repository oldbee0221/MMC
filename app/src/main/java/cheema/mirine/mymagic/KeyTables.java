...
import cheema.mirine.mymagic.adapters.Keytables_list_adapter;
...
public class KeyTables extends AppCompatActivity {
    ...
    public class Loader extends AsyncTask<Void,Void,Void>{
        ...
        //variables
        ProgressDialog dialog = ProgressDialog.show(KeyTables.this,"로딩중","기다려 주세요!");
    }// end class Loader
