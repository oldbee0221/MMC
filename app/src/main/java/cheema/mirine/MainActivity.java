...
import cheema.mirine.CalculatorLib.SrbCalculator;
import cheema.mirine.CalculatorLib.Token;
import cheema.mirine.mymagic.KeyTables;
import cheema.mirine.mymagic.Magic;

import static cheema.mirine.CalculatorLib.Token.lastToken;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        menu.clear();
        if(qusTv.getText().toString().compareTo("0000")!=0) {
            getMenuInflater().inflate(R.menu.menu1, menu);
        }
        else {
